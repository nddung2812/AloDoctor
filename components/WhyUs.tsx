  ...
  return (
    <div className="container grid grid-cols-1 md:grid-cols-2 gap-2 ">
      <div className="text-left font-medium p-4 rounded-sm">
        <h2 className="text-green-300 rounded-sm font-bold border border-gray-400 p-4">Đăng ký qua Alo Doctor</h2>
        <div className="grid grid-cols-1 md:grid-cols-1 gap-2 mt-2 rounded-md border border-gray-400 p-4">
        {rows1.map((row, index) => (
      ...
      <div className="text-left font-medium p-4 rounded-sm">
        <h2 className="text-white rounded-sm font-bold border border-gray-400 p-4">Đăng ký trực tiếp qua Vạn Hạnh</h2>
        <div className="grid grid-cols-1 md:grid-cols-1 gap-2 mt-2 rounded-md border border-gray-400 p-4">
        {rows1.map((row, index) => (
          <React.Fragment key={index}>
            <div className='flex items-center'>
