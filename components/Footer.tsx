  ...
  return (
    <footer className="text-center h-16 sm:h-20 w-full sm:pt-2 pt-4 border-t mt-5 flex sm:flex-row flex-col justify-between items-center px-3 space-y-3 sm:mb-0 mb-3 border-gray-500">
      ...
      <div className="flex items-center pb-4 sm:pb-0">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 25" width="36px" height="36px" fill="#e5e7eb">
       ...
       <a
          href="mailto:alodoctorhelp@gmail.com"
          className="mx-2"
          aria-label="Email Us"
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="30px" height="36px" fill="#e5e7eb" version="1.1" id="Capa_1" viewBox="0 0 75 75">
