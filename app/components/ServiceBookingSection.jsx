      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <UnifiedServiceForm
            ...
            subtitle=""
            successMessage="Thank you! Brisbane's #1 aquarium experts will contact you as soon as possible."
            buttonText="Get Free Quote"
            showServiceType={true}
            cardClassName="bg-white/20 backdrop-blur-md border border-white/30 hover:bg-white/25 hover:border-emerald-400/50 transition-all duration-300"
          />
        </div>
      </div>
    </section>
