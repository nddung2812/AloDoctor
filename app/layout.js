...
export const metadata = {
  ...
  metadataBase: new URL("https://alodoctor.com.au"),
  alternates: {
    canonical: "/",
  },
  openGraph: {
  ...
  other: {
    ...
    "business:contact_data:website": "https://alodoctor.com.au",
  },
};
  ...
  return (
    <html lang="en-AU">
      <head>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "LocalBusiness",
              "@id": "https://alodoctor.com.au/#business",
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              provider: {
                ...
                "@id": "https://alodoctor.com.au/#organization",
              },
              areaServed: {
                "@type": "State",
                name: "Queensland",
        ...
        />
        <meta property="og:url" content="https://alodoctor.com.au" />
